            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Payment is not required at this stage. Once you submit your application, it will be reviewed by the academy administration. After your application is approved, you will be notified to complete the payment process. Until then, please monitor your application status from the Applications section.',
